    ...
    return (
      <div id="footer-wrapper">
        <p>
          ...
          Twitter <a style={{color: "#856300"}} href="https://twitter.com/daniel_swdev">@daniel_swdev</a>{" "}
          and check out <a style={{color: "#856300"}} href="https://danielsarmiento.dev/">my blog</a>.
        </p>
